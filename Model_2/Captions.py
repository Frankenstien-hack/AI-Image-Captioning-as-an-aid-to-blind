...
model = load_model("./Model_2_Weights/model_9.h5")
...
with open("Model_2_index_words/words_to_index.pkl", "rb") as w2i:
    words_to_index = pickle.load(w2i)
    
with open("Model_2_index_words/index_to_words.pkl", "rb") as i2w:
